...
function Footer() {
  ...
  const footerLinks = {
    services: [
      { label: t('footer.servicesLinks.generalRepairs'), href: '#services' },
      { label: t('footer.servicesLinks.fullRenovations'), href: '#services' },
      { label: t('footer.servicesLinks.plumbing'), href: '#services' },
      { label: t('footer.servicesLinks.electricalWork'), href: '#services' }
    ],
    company: [
      { label: t('footer.companyLinks.aboutUs'), href: '#about' },
      { label: t('footer.companyLinks.ourWork'), href: '#work' },
      { label: t('footer.companyLinks.testimonials'), href: '#testimonials' },
      { label: t('footer.companyLinks.contact'), href: '#contact' }
    ],
    legal: [
      { label: t('footer.legalLinks.privacyPolicy'), href: '/legal/privacy' },
      { label: t('footer.legalLinks.termsOfService'), href: '/legal/terms' }
    ]
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">{t('brand.full')}</span>
            </div>
          ...
          {/* Services */}
          <div>
            <h4 className="font-semibold mb-4">{t('footer.servicesHeading')}</h4>
